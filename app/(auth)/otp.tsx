...
export default function OTPScreen() {
  ...
  if (isVerified) {
    return (
      <View style={[styles.container, { justifyContent: 'center', alignItems: 'center' }]}>
        ...
        <LinearGradient
          colors={['rgba(0,217,139,0.12)', 'transparent']}
          start={{ x: 0.5, y: 0.2 }}
          end={{ x: 0.5, y: 0.8 }}
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        colors={['rgba(0,217,139,0.07)', 'transparent']}
        start={{ x: 0.5, y: 0 }}
        end={{ x: 0.5, y: 0.4 }}
        style={StyleSheet.absoluteFill}
        pointerEvents="none"
            ...
            {params.type === 'register' && (
              <Animated.View entering={FadeInDown.springify().damping(12)} style={styles.stepContainer}>
                <View style={styles.stepBarRow}>
                  ...
                  <View style={[styles.stepBar, styles.stepBarIdle]} />
                </View>
...
const styles = StyleSheet.create({
  ...
  stepBarDone: { backgroundColor: PRIMARY + '80' },
  stepBarActive: { backgroundColor: PRIMARY },
  stepBarIdle: { backgroundColor: 'rgba(255,255,255,0.08)' },
  stepLabel: { fontSize: 13, fontWeight: '600', color: TEXT_MUTED },
  ...
  shieldInnerRing: {
    ...
    borderWidth: 1, borderColor: 'rgba(0,217,139,0.2)',
    backgroundColor: 'rgba(0,217,139,0.06)',
    justifyContent: 'center', alignItems: 'center',
  },
  shieldCircle: {
    width: 72, height: 72, borderRadius: 36,
    backgroundColor: 'rgba(0,217,139,0.12)',
    justifyContent: 'center', alignItems: 'center',
  },
  ...
  resendBtnText: { fontSize: 14, fontWeight: '700', color: PRIMARY },
